...
function Footer() {
  return (
    <footer className="p-10 flex flex-col justify-center items-center">
      <div className="flex flex-row justify-between lg:justify-center border-t-gray-800/[0.5] border-t-2">
        <div></div>
      ...
      <p className=" text-xs underline dark:text-white text-black">
